...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "thor.ipc", false, filepath.Join(os.TempDir(), "thor.ipc")},
		{"data", "thor.ipc", false, "data/thor.ipc"},
		{"data", "./thor.ipc", false, "./thor.ipc"},
		{"data", "/thor.ipc", false, "/thor.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "thor.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "thor.ipc", true, `\\.\pipe\geth.ipc`},
