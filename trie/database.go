...
type Database struct {
	diskdb thordb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb thordb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb thordb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() thordb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch thordb.Batch, uncacher *cleaner) error {
