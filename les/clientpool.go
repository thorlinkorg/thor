...
func newClientPool(db thordb.Database, freeClientCap uint64, clock mclock.Clock, removePeer func(enode.ID)) *clientPool {
...
func newNodeDB(db thordb.Database, clock mclock.Clock) *nodeDB {
