...
import (
	...
	"github.com/thorlinkorg/thor/p2p/simulations"
	"github.com/thorlinkorg/thor/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext) (node.Service, error) {
	...
	ethereum, err := thor.New(ctx.NodeContext, &config)
	if err != nil {
		return nil, err
	}
