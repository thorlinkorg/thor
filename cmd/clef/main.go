...
import (
	...
	"github.com/thorlinkorg/thor/signer/core"
	"github.com/thorlinkorg/thor/signer/fourbyte"
	"github.com/thorlinkorg/thor/signer/rules"
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &thorapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
