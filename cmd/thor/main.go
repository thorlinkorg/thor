...
// thor is the official command-line client for Ethereum.
package main
...
import (
	...
	"github.com/thorlinkorg/thor/cmd/utils"
	"github.com/thorlinkorg/thor/common"
	"github.com/thorlinkorg/thor/console"
	"github.com/thorlinkorg/thor/internal/debug"
...
const (
	clientIdentifier = "thor" // Client identifier to advertise over the network
)
...
func init() {
	// Initialize the CLI app and start Thor
	app.Action = geth
...
func prepare(ctx *cli.Context) {
	...
	case ctx.GlobalIsSet(utils.LegacyTestnetFlag.Name):
		log.Info("Starting Thor on Ropsten testnet...")
	...
	case ctx.GlobalIsSet(utils.RinkebyFlag.Name):
		log.Info("Starting Thor on Rinkeby testnet...")

	case ctx.GlobalIsSet(utils.GoerliFlag.Name):
		log.Info("Starting Thor on Görli testnet...")

	case ctx.GlobalIsSet(utils.DeveloperFlag.Name):
		log.Info("Starting Thor in ephemeral dev mode...")

	case !ctx.GlobalIsSet(utils.NetworkIdFlag.Name):
		log.Info("Starting Thor mainnet...")
	}
