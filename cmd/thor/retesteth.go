...
import (
	...
	"github.com/thorlinkorg/thor/consensus/misc"
...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches thor in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches thor in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
func (api *RetestethAPI) ClientVersion(ctx context.Context) (string, error) {
	return "Thor-" + params.VersionWithCommit(gitCommit, gitDate), nil
}
