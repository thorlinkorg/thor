...
import (
	...
	"github.com/thorlinkorg/thor/accounts"
	"github.com/thorlinkorg/thor/accounts/keystore"
	"github.com/thorlinkorg/thor/common"
	"github.com/thorlinkorg/thor/common/fdlimit"
	"github.com/thorlinkorg/thor/consensus"
	"github.com/thorlinkorg/thor/consensus/clique"
	"github.com/thorlinkorg/thor/consensus/ethash"
	"github.com/thorlinkorg/thor/core"
	"github.com/thorlinkorg/thor/core/vm"
	"github.com/thorlinkorg/thor/crypto"
	"github.com/thorlinkorg/thor/graphql"
	"github.com/thorlinkorg/thor/les"
	"github.com/thorlinkorg/thor/log"
	"github.com/thorlinkorg/thor/metrics"
	"github.com/thorlinkorg/thor/metrics/influxdb"
	"github.com/thorlinkorg/thor/miner"
	"github.com/thorlinkorg/thor/node"
	"github.com/thorlinkorg/thor/p2p"
	"github.com/thorlinkorg/thor/p2p/discv5"
	"github.com/thorlinkorg/thor/p2p/enode"
	"github.com/thorlinkorg/thor/p2p/nat"
	"github.com/thorlinkorg/thor/p2p/netutil"
	"github.com/thorlinkorg/thor/params"
	"github.com/thorlinkorg/thor/rpc"
	"github.com/thorlinkorg/thor/thor"
	"github.com/thorlinkorg/thor/thor/downloader"
	"github.com/thorlinkorg/thor/thor/gasprice"
	"github.com/thorlinkorg/thor/thordb"
	"github.com/thorlinkorg/thor/thorstats"
	whisper "github.com/thorlinkorg/thor/whisper/whisperv6"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: thor.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = thor.DefaultConfig.SyncMode
	...
	LightServeFlag = cli.IntFlag{
		...
		Value: thor.DefaultConfig.LightServ,
	}
	LightIngressFlag = cli.IntFlag{
		Name:  "light.ingress",
		Usage: "Incoming bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: thor.DefaultConfig.LightIngress,
	}
	LightEgressFlag = cli.IntFlag{
		Name:  "light.egress",
		Usage: "Outgoing bandwidth limit for serving light clients (kilobytes/sec, 0 = unlimited)",
		Value: thor.DefaultConfig.LightEgress,
	}
	LightMaxPeersFlag = cli.IntFlag{
		Name:  "light.maxpeers",
		Usage: "Maximum number of light clients to serve, or light servers to attach to",
		Value: thor.DefaultConfig.LightPeers,
	}
	UltraLightServersFlag = cli.StringFlag{
		Name:  "ulc.servers",
		Usage: "List of trusted ultra-light servers",
		Value: strings.Join(thor.DefaultConfig.UltraLightServers, ","),
	}
	UltraLightFractionFlag = cli.IntFlag{
		Name:  "ulc.fraction",
		Usage: "Minimum % of trusted ultra-light servers required to announce a new head",
		Value: thor.DefaultConfig.UltraLightFraction,
	}
	...
	EthashCachesInMemoryFlag = cli.IntFlag{
		...
		Value: thor.DefaultConfig.Ethash.CachesInMem,
	}
	EthashCachesOnDiskFlag = cli.IntFlag{
		Name:  "ethash.cachesondisk",
		Usage: "Number of recent ethash caches to keep on disk (16MB each)",
		Value: thor.DefaultConfig.Ethash.CachesOnDisk,
	}
	...
	EthashDatasetDirFlag = DirectoryFlag{
		...
		Value: DirectoryString(thor.DefaultConfig.Ethash.DatasetDir),
	}
	EthashDatasetsInMemoryFlag = cli.IntFlag{
		Name:  "ethash.dagsinmem",
		Usage: "Number of recent ethash mining DAGs to keep in memory (1+GB each)",
		Value: thor.DefaultConfig.Ethash.DatasetsInMem,
	}
	EthashDatasetsOnDiskFlag = cli.IntFlag{
		Name:  "ethash.dagsondisk",
		Usage: "Number of recent ethash mining DAGs to keep on disk (1+GB each)",
		Value: thor.DefaultConfig.Ethash.DatasetsOnDisk,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: thor.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: thor.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: thor.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: thor.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: thor.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: thor.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: thor.DefaultConfig.TxPool.Lifetime,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: thor.DefaultConfig.Miner.GasFloor,
	}
	MinerGasLimitFlag = cli.Uint64Flag{
		Name:  "miner.gaslimit",
		Usage: "Target gas ceiling for mined blocks",
		Value: thor.DefaultConfig.Miner.GasCeil,
	}
	MinerGasPriceFlag = BigFlag{
		Name:  "miner.gasprice",
		Usage: "Minimum gas price for mining a transaction",
		Value: thor.DefaultConfig.Miner.GasPrice,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: thor.DefaultConfig.Miner.Recommit,
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: thor.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpo.percentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: thor.DefaultConfig.GPO.Percentile,
	}
	...
	OdinRPCFlag = cli.StringFlag{
		Name:  "odin.rpc",
		Usage: "Odin RPC URL",
		Value: "",
	}
	OdinContractFlag = cli.StringFlag{
		Name:  "odin.contract",
		Usage: "Odin Contract address to request for assets proof",
		Value: "",
	}
)
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(LegacyTestnetFlag.Name) || ctx.GlobalBool(RopstenFlag.Name) {
			// Maintain compatibility with older Thor configurations storing the
...
func setLes(ctx *cli.Context, cfg *thor.Config) {
	...
	if cfg.UltraLightFraction <= 0 && cfg.UltraLightFraction > 100 {
		log.Error("Ultra light fraction is invalid", "had", cfg.UltraLightFraction, "updated", thor.DefaultConfig.UltraLightFraction)
		cfg.UltraLightFraction = thor.DefaultConfig.UltraLightFraction
	}
...
// for Thor and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `thor account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *thor.Config) {
...
func setEthash(ctx *cli.Context, cfg *thor.Config) {
	...
	if ctx.GlobalIsSet(OdinRPCFlag.Name) {
		cfg.Ethash.OdinRPC = ctx.GlobalString(OdinRPCFlag.Name)
	}
	if ctx.GlobalIsSet(OdinContractFlag.Name) {
		cfg.Ethash.OdinContract = common.HexToAddress(ctx.GlobalString(OdinContractFlag.Name))
	}
}
...
func setWhitelist(ctx *cli.Context, cfg *thor.Config) {
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *thor.Config) {
...
// no URLs are set.
func setDNSDiscoveryDefaults(cfg *thor.Config, url string) {
...
func RegisterEthService(stack *node.Node, cfg *thor.Config) {
	var err error
...
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		return thorstats.New(url, ethServ, lesServ)
	}); err != nil {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "thor.", tagsMap)
		}
	}
}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) thordb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node, readOnly bool) (chain *core.BlockChain, chainDb thordb.Database) {
	var err error
	...
	if config.Clique != nil {
		...
		if !ctx.GlobalBool(FakePoWFlag.Name) {
			engine = ethash.New(ethash.Config{
				CacheDir:         stack.ResolvePath(thor.DefaultConfig.Ethash.CacheDir),
				CachesInMem:      thor.DefaultConfig.Ethash.CachesInMem,
				CachesOnDisk:     thor.DefaultConfig.Ethash.CachesOnDisk,
				CachesLockMmap:   thor.DefaultConfig.Ethash.CachesLockMmap,
				DatasetDir:       stack.ResolvePath(thor.DefaultConfig.Ethash.DatasetDir),
				DatasetsInMem:    thor.DefaultConfig.Ethash.DatasetsInMem,
				DatasetsOnDisk:   thor.DefaultConfig.Ethash.DatasetsOnDisk,
				DatasetsLockMmap: thor.DefaultConfig.Ethash.DatasetsLockMmap,
			}, nil, false)
		}
	}
	if gcmode := ctx.GlobalString(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
	...
	cache := &core.CacheConfig{
		TrieCleanLimit:      thor.DefaultConfig.TrieCleanCache,
		TrieCleanNoPrefetch: ctx.GlobalBool(CacheNoPrefetchFlag.Name),
		TrieDirtyLimit:      thor.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled:   ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:       thor.DefaultConfig.TrieTimeout,
		SnapshotLimit:       thor.DefaultConfig.SnapshotCache,
	}
	if !ctx.GlobalIsSet(SnapshotFlag.Name) {
...
// new format.
//
// e.g. thor account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// thor --keystore /tmp/mykeystore --lightkdf account new
//
