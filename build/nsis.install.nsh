...
!define HELPURL "https://github.com/thorlinkorg/thor/issues"
!define UPDATEURL "https://github.com/thorlinkorg/thor/releases"
!define ABOUTURL "https://github.com/thorlinkorg/thor#ethereum-go"
...
Section "Thor" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Thor incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Thor outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Thor UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Thor incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Thor outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Thor UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
