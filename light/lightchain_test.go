...
func makeHeaderChain(parent *types.Header, n int, db thordb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (thordb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() thordb.Database {
	return odr.db
}
