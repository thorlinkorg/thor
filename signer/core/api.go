...
import (
	...
	"github.com/thorlinkorg/thor/signer/storage"
)
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*thorapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx thorapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*thorapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := thorapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
