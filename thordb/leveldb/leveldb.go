...
func (db *Database) NewBatch() thordb.Batch {
	return &batch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *Database) NewIterator(prefix []byte, start []byte) thordb.Iterator {
...
func (b *batch) Replay(w thordb.KeyValueWriter) error {
	return b.b.Replay(&replayer{writer: w})
}

// replayer is a small wrapper to implement the correct replay methods.
type replayer struct {
	writer  thordb.KeyValueWriter
	failure error
}
