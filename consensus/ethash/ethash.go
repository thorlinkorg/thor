...
var (
	...
	sharedEthash = New(Config{"", 3, 0, false,
		"", "", common.Address{}, 1, 0, false,
		ModeNormal, nil}, nil, false)
...
func (ethash *Ethash) SetOdinAccessor(o OdinAccessor) {
	ethash.odinAccessor = o
}
