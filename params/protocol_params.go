...
var (
	...
	GenesisDifficulty      = big.NewInt(25200000000) // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(25200000000) // The minimum that the difficulty may ever be.
