...
type Tree struct {
	diskdb thordb.KeyValueStore     // Persistent database to store the snapshot
...
// background thread.
func New(diskdb thordb.KeyValueStore, triedb *trie.Database, cache int, root common.Hash, async bool) *Tree {
