...
func wipeSnapshot(db thordb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db thordb.KeyValueStore) error {
...
func wipeKeyRange(db thordb.KeyValueStore, kind string, prefix []byte, keylen int) error {
