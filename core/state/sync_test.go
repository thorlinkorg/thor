...
// account array.
func checkStateAccounts(t *testing.T, db thordb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db thordb.Database, root common.Hash) error {
...
func checkStateConsistency(db thordb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(thordb.Database), srcRoot)
