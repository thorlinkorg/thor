...
import (
	...
	"github.com/thorlinkorg/thor/thordb/leveldb"
	"github.com/thorlinkorg/thor/thordb/memorydb"
)

// freezerdb is a database wrapper that enabled freezer data retrievals.
type freezerdb struct {
	thordb.KeyValueStore
	thordb.AncientStore
}
...
func NewDatabase(db thordb.KeyValueStore) thordb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db thordb.KeyValueStore, freezer string, namespace string) (thordb.Database, error) {
...
func NewMemoryDatabase() thordb.Database {
...
func NewMemoryDatabaseWithCap(size int) thordb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (thordb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (thordb.Database, error) {
...
func InspectDatabase(db thordb.Database) error {
