...
func NewTable(db thordb.Database, prefix string) thordb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) thordb.Iterator {
...
func (t *table) NewBatch() thordb.Batch {
...
func (b *tableBatch) Replay(w thordb.KeyValueWriter) error {
