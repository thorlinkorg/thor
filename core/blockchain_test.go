...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (thordb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (thordb.Database, func()) {
...
//
// https://github.com/thorlinkorg/thor/pull/15941
...
//
// Details at:
//  - https://github.com/thorlinkorg/thor/issues/18977
//  - https://github.com/thorlinkorg/thor/pull/18988
