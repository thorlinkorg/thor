...
import (
	...
	"github.com/thorlinkorg/thor/internal/jsre/deps"
	"github.com/thorlinkorg/thor/internal/web3ext"
...
// Welcome show summary of current Thor instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Thor JavaScript console!\n\n"

	// Print some generic Thor metadata
