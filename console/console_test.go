...
import (
	...
	"github.com/thorlinkorg/thor/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*thor.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return thor.New(ctx, ethConf) }); err != nil {
